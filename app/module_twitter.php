...
function disp_twitter($thisurl) {
	...
	*/
	...
	<form action="<?=$thisurl?>" name="twitter_en_vrai" method="POST">
		...
		<button class="twitter_fermer"><img src="cjs/img/bouton_croix_bis.png"/></button>
		...
		<div class="twitter_message_zone">
			<textarea class="twitter_message" maxlength="140" name="twitter_message" placeholder="Texte du tweet. N'oubliez pas l'adresse du stream !"></textarea>
			<div>
